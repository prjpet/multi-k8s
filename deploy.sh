...
kubectl set image deployments/client-deployment server=peterprjevara/multi-client:$SHA
kubectl set image deployments/worker-deployment server=peterprjevara/multi-worker:$SHA
