...
kubectl set image deployment/client-deployment server=peterprjevara/multi-client:$SHA
kubectl set image deployment/worker-deployment server=peterprjevara/multi-worker:$SHA
